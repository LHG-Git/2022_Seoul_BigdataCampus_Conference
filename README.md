...
# 💡 가설설정
* 가설1 : 누적휴일이 길어질수록 승하차 수가 감소할 것이다.<br>
* 가설2 : 대학교 주변의 역은 여름, 겨울 시즌에 승하차 수가 감소할 것이다.<br><br>
<br>
...
* 상업지역은 시간과 관계없이 골고루 유동인구가 분포함

* 주거지역은 출근시간에는 승차가, 퇴근시간에는 하차가 많음

* 업무지역은 출근시간에는 하차가, 퇴근시간에는 승차가 많음
<br><br>
# 📄 Modeling
